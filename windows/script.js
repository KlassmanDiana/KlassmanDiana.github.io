...
var modals = function modals() {
  ...
  bindModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // showModalByTime('.popup', 100000);
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    tabs[i].classList.add(activeClass); // добавить класс активности
  }

  hideTabContent(); // сначала все скрыть

  showTabContent(); // отобразить первый таб
